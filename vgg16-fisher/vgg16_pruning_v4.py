...
class VGGPruningConfig:
    ...
    rho_fc_b: Tuple[float, float] = (2e-5, 2e-5)  # output bias unpruned
    ...
    prune_fraction_cap: Optional[float] = 0.20
...
def run_pruning_experiment(cfg: VGGPruningConfig, resume_checkpoint: Optional[str] = None):
    ...
    out_path = "vgg16_pruned_and_compressed_v4_99pct.pt"
