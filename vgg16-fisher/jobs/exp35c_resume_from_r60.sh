#!/bin/bash
#SBATCH --job-name=ai-research/exp35c-resume-r60
...
# Resume from r60 checkpoint (97.3% sparsity) — push to 99%
python3 experiments/35_vgg16_perlayer_rho.py \
    ...
    --fisher-batches 5 \
    --seed 0 \
    --resume /home/petty/pruning-research/vgg16-fisher/vgg16_exp35_r60.pt
